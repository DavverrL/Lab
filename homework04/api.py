...
def get_friends(user_id, fields = "id"):
    ...
    access_token = '3a3088cb3a3088cb3a3088cb223a58beb433a303a3088cb6677defa5d25ede16c1dad32'
    user_id = user_id
...
def messages_get_history(user_id, offset, need_count):
    ...
    plotly.tools.set_credentials_file(username='Elzsur', api_key='GENoqXwkWQyLcVQyFHif')  # Авторизация в pltly
    try:
